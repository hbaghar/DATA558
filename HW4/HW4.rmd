...
\begin{cases}
\beta_0 + \beta_1X + \beta_2X^2 + \beta_3X^3 &\text{ if } X \le \psi_1\\
\beta_0 + \beta_1X + \beta_2X^2 + \beta_3X^3 + \beta_4(X - \psi)^3 &\text{ if } X \gt \psi_1\\
\end{cases}
$$
...
\beta_1 + 2\beta_2X + 3\beta_3X^2 + 3\beta_4(X - \psi)^2\times1 &\text{ if } X \gt \psi\\
\end{cases}
$$
...
2\beta_2 + 3\times2\beta_3X + 3\times2\beta_4(X - \psi) &\text{ if } X \gt \psi\\
\end{cases}
$$
