...
\begin{equation}
\begin{split}
MPG_{Japan} &= \beta_0 = 25.2395 \\
MPG_{USA} &= \beta_0 + \beta_1  = 25.2395 - 1.8453 =23.3942\\
MPG_{Europe} &= \beta_0 + 2\beta_1 = 25.2395 - 2 \times1.8453 = 21.5489\\
\end{split}
\end{equation}
$$
...
$$
-x^2 = 2log(\frac{0.55}{0.45}\frac{\sqrt{2\pi}}{4}) = -0.533 \\
x = ± 0.73
$$
TODO:
...
$$
\mu = \frac{1}{n_1} \sum_{i: y_i =1} x_i
$$

$$
\sigma = \sqrt{\frac{1}{n_1-1}\sum_{i:y_i=1}(x_i - \mu)^2}
$$
$$
\pi_1 = \frac{n_1}{n}
$$
...
$$
P(Y=1|X=x_0) = \frac{\frac{1}{\sqrt{2\pi}\sigma}e^{-\frac{(x_0-\mu)^2}{2\sigma^2}}\pi_1}{\frac{1}{\sqrt{2\pi}\sigma}e^{-\frac{(x_0-\mu)^2}{2\sigma^2}}\pi_1 + \frac{1}{4}(1-\pi_1)}
$$
TODO:
...
\begin{equation}
\begin{split}
\implies log(\frac{P(x*)}{1-P(x*)}) &= \beta_0+\beta_1x_1^*+\beta_2x_2^*+\beta_3x_3^*+\beta_4x_4+...\beta_px_p\\
\frac{P(x*)}{1-P(x*)} &= e^{\beta_0+\beta_1(x_1+1)+\beta_2(x_2-1)+\beta_3(x_3+2)+\beta_4x_4+...\beta_px_p}\\
\frac{P(x*)}{1-P(x*)} &= e^{\beta_1-\beta_2+2\beta_3}.e^{\beta_0+\beta_1x_1+...\beta_px_p}\\
\frac{P(x*)}{1-P(x*)} &= e^{\beta_1-\beta_2+2\beta_3+0.7}\ \\&(\because \beta_0+\beta_1x_1+...\beta_px_p\ is\ log \ odds \ for \ observation \ x)\\
\therefore P(Y=1|X=x^*) &= \frac{e^{\beta_1-\beta_2+2\beta_3+0.7}}{1+e^{\beta_1-\beta_2+2\beta_3+0.7}}
\end{split}
\end{equation}
$$
...
- Add annotation to graph if possible
